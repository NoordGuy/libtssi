/* 
   ...
   Microsoft is not related in any way to libtssi.

*/

//
// list of changes: 
//   BYTE		replaced with TS_BYTE
//   WORD		replaced with TS_WORD
//   DWORD		replaced with TS_DWORD
//   ULONGLONG	replaced with TS_ULONGLONG
...
#define BYTE_VALUE(pb,i)            (((TS_BYTE *) (pb))[i])
#define WORD_VALUE(pb,i)            (* (UNALIGNED TS_WORD *) BYTE_OFFSET((pb),i))
#define DWORD_VALUE(pb,i)           (* (UNALIGNED TS_DWORD *) BYTE_OFFSET((pb),i))
#define ULONGLONG_VALUE(pb,i)       (* (UNALIGNED TS_QWORD *) BYTE_OFFSET((pb),i))
#define QWORD_VALUE(pb,i)           (* (UNALIGNED TS_QWORD *) BYTE_OFFSET((pb),i))
...
#define PCR_EXT_VALUE(pb)                               ((TS_DWORD) (NTOH_LL(ULONGLONG_VALUE(pb,0)) & 0x00000000000001ff))
...
#define PAT_PROGRAM_DESCRIPTOR(pbPAT,n)                 ((((TS_BYTE *) (pbPAT)) + 8) + ((n) * 4))
...
#define PES_HEADER_DATA_LENGTH_VALUE(pb)				BYTE_VALUE(pb,2)
...
#define VALID_PSI_HEADER(pbSection)                                                                 \
            ( (PSI_SECTION_LENGTH_VALUE(pbSection) <= 0xffd)                                    &&  \
...
#define VALID_PAT_SECTION(pbPAT)                                            \
            ( VALID_PSI_HEADER(pbPAT)                                   &&  \
              ...
              (PAT_TABLE_ID_VALUE(pbPAT) == 0x00) )

//  returns the number of programs described in the passed PAT section
#define NUMBER_PROGRAMS_IN_PAT_SECTION(pbPAT)   ((TS_DWORD) ((PAT_SECTION_LENGTH_VALUE(pbPAT) - 5 - 4) / 4))
...
#define INCREMENTED_CONTINUITY_COUNTER_VALUE(c) ((TS_BYTE) (((c) + 1) & 0x0000000f))
